...
################################################################################
## Form generated from reading UI file 'proveedorProductoBorrarFgNNEO.ui'
##
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow,relationship):
    ...
    def delete(self):
        ...
        self.cursor.execute(f"DELETE FROM producto_proveedor WHERE id_pp = {self.relationship};")
        self.mainWindow.close()
...
"borrar la relaci\u00f3n del producto con\n"
"el proveedor?", None))
    # retranslateUi

class proveedorProductoBorrar(QMainWindow):
    def __init__(self,relationship):
        super().__init__()
        self.ui = Ui_MainWindow()
        self.ui.setupUi(self,relationship)